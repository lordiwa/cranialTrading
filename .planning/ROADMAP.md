...
- [x] 04-02-PLAN.md — ARIA combobox template wiring in GlobalSearch.vue + MobileSearchOverlay.vue (parallel siblings) (ARCH-10)
- [x] 04-03-PLAN.md — RouterLink conversions across 8 files + i18n keys in en/es/pt (NICE-11, closes ARCH-10 i18n)
**UI hint**: yes
