...
<template>
  <div ref="containerRef">
    ...
    <div v-if="props.loadingMore" class="flex justify-center items-center py-6">
      <div class="flex items-center gap-2 text-silver-50 text-small">
        <svg class="animate-spin h-5 w-5 text-neon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
