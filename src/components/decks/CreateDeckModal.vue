      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <textarea
              ...
              class="w-full px-4 py-3 bg-primary border border-silver-30 text-silver placeholder:text-silver-50 font-sans text-tiny focus:outline-none focus:border-neon transition-150 resize-none h-32"
          />
          <!-- Preview -->
