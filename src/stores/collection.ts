...
export const useCollectionStore = defineStore('collection', () => {
    ...
    let _lastQueryFilters: QueryCardIndexRequest['filters'] | undefined
    let _lastQuerySort: QueryCardIndexRequest['sort'] | undefined
    ...
    const resetPagination = () => {
        ...
        _lastQueryFilters = undefined
        _lastQuerySort = undefined
    }
