...
// ========== IMPORT + DELETE COMPOSABLES (Plan 03-B) ==========
// Wired here (after selectedDeck) because useDeckDeletion receives selectedDeck ref
const {
  importProgress,
  isDeckImporting,
  getImportProgress,
...
// extractScryfallImage, extractScryfallCardData moved to src/composables/useCollectionImport.ts (Plan 03-B)
...
// _processImportCard, _applySearchResultToCard, _enrichCardsWithFallbackSearch, _buildCsvCollectionCard,
// executeCardDeletionStep moved to src/composables/useCollectionImport.ts and useDeckDeletion.ts (Plan 03-B)
...
// executeDeleteDeck, resumeDeleteDeck, handleDeleteDeck moved to src/composables/useDeckDeletion.ts (Plan 03-B)
...
// resumeImport moved to src/composables/useCollectionImport.ts (Plan 03-B)
